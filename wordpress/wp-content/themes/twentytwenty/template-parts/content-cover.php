...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	...
	<div class="cover-header <?php echo esc_attr( $cover_header_classes ); ?>"<?php echo $cover_header_style; ?>>
			...
			<div class="cover-header-inner">
				...
				<header class="entry-header has-text-align-center">
					<div class="entry-header-inner section-inner medium">
						...
						<?php else :
							$intro_text_width = is_singular() ? ' small' : ' thin';

							// CHỈ hiển thị excerpt/intro-text khi KHÔNG phải single post
							if ( has_excerpt() && ! is_singular( 'post' ) ) : ?>
